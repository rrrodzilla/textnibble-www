      ...
      <div class="relative px-4 sm:px-6 lg:px-8">
        <span class="inline-flex rounded-md shadow-sm">
          <button
            type="button"
            @click="goBack"
            class="inline-flex items-center px-6 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-accentDarker hover:bg-accentLight focus:outline-none focus:border-accentDarker focus:shadow-outline-indigo active:bg-accentDarker transition ease-in-out duration-150"
          >
        ...
        <div class="text-lg max-w-prose mx-auto mb-6">
          <a href="/" aria-label="Home">
            <img
              ...
              class="mx-auto object-contain h-12 mt-10 sm:h-28"
            />
          </a>
        </div>
        <div class="prose prose-sm text-gray-500 mx-auto">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Cruising Life, Inc, dba (doing business as) Textnibble, 8 The Green Suite #5812 Dover, DE 19901.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Textnibble, accessible from
                <a
                  href="https://www.textnibble.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >https://www.textnibble.com</a>
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              <strong>The right to access / the right to request.</strong> The CCPA permits You to request and obtain from the Company information regarding the disclosure of Your Personal Data that has been collected in the past 12 months by the Company or its subsidiaries to a third-party for the third party's direct marketing purposes.
            </li>
            <li>
          ...
          <ul>
            <li>By email: support@textnibble.com</li>
          </ul>
        </div>
      </div>
    </div>
